...
public class SudokuFrame extends JFrame {
  ...
  save.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(ActionEvent arg0) {
    ...
    if (result == JFileChooser.APPROVE_OPTION) {
     //String content = "abc";// need to get coordinates here write only takes int
 ...
 fillMany.addActionListener(new ActionListener() {
	  public void actionPerformed(ActionEvent ev) 	{
		  ...
		  while(puzzle.NakedAlgo() /*|| puzzle.LockedAlgo()*/) {
			  puzzle.SingleAlgo();
			  revalidate();
			  repaint();
		  }
 ...
 public void rebuildInterface(SudokuPuzzleType puzzleType, int fontSize, String[][] coords) {
  //SudokuPuzzle generatedPuzzle = new SudokuGenerator().generateRandomSudoku(puzzleType, coords);
  ...
  SudokuCell[][] cor = cellsFromSudoku();
  ...
  JToggleButton hint = new JToggleButton("hint", false);
 ...
 public static SudokuCell[][] cellsFromSudoku() {

  SudokuCell[][] cellCoordinates = new SudokuCell[9][9];
  /// @SuppressWarnings("static-access")
  // SudokuPuzzleType[] i = puzzleType.NINEBYNINE.values();
